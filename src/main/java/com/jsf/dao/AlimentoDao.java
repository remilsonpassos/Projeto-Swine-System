...
public class AlimentoDao implements Serializable{
	...
	public Alimento todos() {

		try {

			StringBuffer hql = new StringBuffer();
			hql.append("SELECT u FROM Alimento u ");		

			Query query = this.em.createQuery(hql.toString());			

			return (Alimento) query.getSingleResult();
	...
	@Transactional
	public boolean edita(Alimento alimento) {
		try {			
	...
	public List<Alimento> filtrados(FiltroPaginacao filtro) {
